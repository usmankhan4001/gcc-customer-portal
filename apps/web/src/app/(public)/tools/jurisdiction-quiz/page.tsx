  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center">
      <div className="pt-10 pb-4 text-center">
        <h1 className="text-2xl font-bold text-gray-900">Jurisdiction Fit Quiz</h1>
        <p className="text-sm text-gray-500 mt-1">Answer 4 quick questions to reveal your optimal global incorporation structure.</p>
      </div>
