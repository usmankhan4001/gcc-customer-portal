  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <main className="flex-grow p-4 max-w-3xl mx-auto w-full">
        ...
        {/* Output */}
        <div className={`p-4 rounded-md mb-4 border transition-colors duration-300 ${
          isEligible 
          ...
          <div className="flex items-start gap-4 text-sm mt-2">
            ...
            <div className="opacity-90">
              {isEligible 
                ? 'Based on your selected business activity and visa requirements, you appear eligible for 100% foreign ownership under the QFZP.' 
